...
description: "Getting started with Docker Compose for multi-container application orchestration and management."
date: "2021-07-14"
draft: false
tags: ["docker"]
---
...
http
  .createServer(async function (req, res) {
    ...
    const content = movies
      .map(({ universe, title, year }) => `${universe} (${title}) - Released on ${year}`)
