...
The workflow file is in my repo if you want to check it out: [[github.com/thecaffeinedev/iprabhat.dev](https://github.com/thecaffeinedev/iprabhat.dev)](https://github.com/thecaffeinedev/iprabhat.dev)
